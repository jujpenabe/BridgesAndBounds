...
func _produce() -> void:
	...
	print("Current villagers: " + str(_a_villagers.size() + _b_villagers.size() + _c_villagers.size() ) + "Work: " + str(work) + "Progress: " + str(_effort) + " total resources: " + str(_wood))
...
func _on_cancel_a_order() -> void:
	# if the timer is less than the wait time unassign follower
